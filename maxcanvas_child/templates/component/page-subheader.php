 ...
 */
?>
<div class="promo__main wow fadeInUp" style="visibility: hidden">
...
<img class="promo__img wow fadeInRight" src="<?=get_field('subheader_image');?>" alt="<?=get_bloginfo('name');?>" style="visibility: hidden">
